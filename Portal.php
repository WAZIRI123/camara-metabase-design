<?php include 'partials/header.php'; ?>
  <main class="main">
    ...
    <?php include 'partials/Portal/overall/1edPortalUsageGraphSchoolWise.php'; ?>

    <?php include 'partials/Portal/overall/2edPortalUsageTableSchoolWise.php'; ?>

    <?php include 'partials/Portal/overall/3GeoMapper.php'; ?>

    <?php include 'partials/Portal/overall/4VideoViewsStats.php'; ?>

    <?php include 'partials/Portal/overall/5DocumentViewsStats.php'; ?>

    <?php include 'partials/Portal/overall/6UsageDistributionContentWise.php'; ?>

    <?php include 'partials/Portal/overall/7AppletsUsageDistributionActivities.php'; ?>
...
<script>
  ...
  const iframes = [
    ...
    {iframe: document.getElementById('3GeoMapper'), section: document.getElementById('DailyUsage1')},

    {iframe: document.getElementById('4VideoViewsStats'), section: document.getElementById('contact1')},

    {iframe: document.getElementById('5DocumentViewsStats'), section: document.getElementById('DailyUsage2')},
    {iframe: document.getElementById('6UsageDistributionContentWise'), section: document.getElementById('contact2')},

{iframe: document.getElementById('7AppletsUsageDistributionActivities'), section: document.getElementById('DailyUsage3')},
  ];
  ...
  const queryParams = `?firstDate=${startDate}&lastDate=${endDate}&country=${country}&project=${project_name}#hide_parameters=firstDate,lastDate,country,project`;
