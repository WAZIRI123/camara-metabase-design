<?php include 'partials/header.php'; ?>
  <main class="main">
    ...
    <?php include 'partials/Regions/1ReginalTotalTimeActiveInactiveAway.php'; ?>

    <?php include 'partials/Regions/2RegionalSchoolGeneralUsageSummary.php'; ?>

    <?php include 'partials/Regions/3RegionalSchoolGeneralUsage.php'; ?>

    <?php include 'partials/Regions/4RegionalSchoolClientDistributionMonthly.php'; ?>
...
<script>
  ...
  const iframes = [
    ...
    {iframe: document.getElementById('2RegionalSchoolGeneralUsageSummary'), section: document.getElementById('DailyUsage')},

    {iframe: document.getElementById('3RegionalSchoolGeneralUsage'), section: document.getElementById('contact1')},
